...
begin
  ...
  begin
    ...
    case Ch of
      ...
      '"': Result := Result + '&quot;';
      #160: Result := Result + '&nbsp;';
      Char(161): Result := Result + '&iexcl;';
      Char(162): Result := Result + '&cent;';
      Char(163): Result := Result + '&pound;';
      Char(164): Result := Result + '&curren;';
      Char(165): Result := Result + '&yen;';
      Char(166): Result := Result + '&brvbar;';
      Char(167): Result := Result + '&sect;';
      Char(168): Result := Result + '&uml;';
      Char(169): Result := Result + '&copy;';
      Char(170): Result := Result + '&ordf;';
      Char(171): Result := Result + '&laquo;';
      Char(172): Result := Result + '&not;';
      Char(173): Result := Result + '&shy;';
      Char(174): Result := Result + '&reg;';
      Char(175): Result := Result + '&macr;';
      Char(176): Result := Result + '&deg;';
      Char(177): Result := Result + '&plusmn;';
      Char(178): Result := Result + '&sup2;';
      Char(179): Result := Result + '&sup3;';
      Char(180): Result := Result + '&acute;';
      Char(181): Result := Result + '&micro;';
      Char(182): Result := Result + '&para;';
      Char(183): Result := Result + '&middot;';
      Char(184): Result := Result + '&cedil;';
      Char(185): Result := Result + '&sup1;';
      Char(186): Result := Result + '&ordm;';
      Char(187): Result := Result + '&raquo;';
      Char(188): Result := Result + '&frac14;';
      Char(189): Result := Result + '&frac12;';
      Char(190): Result := Result + '&frac34;';
      Char(191): Result := Result + '&iquest;';
      Char(192): Result := Result + '&Agrave;';
      Char(193): Result := Result + '&Aacute;';
      Char(194): Result := Result + '&Acirc;';
      Char(195): Result := Result + '&Atilde;';
      Char(196): Result := Result + '&Auml;';
      Char(197): Result := Result + '&Aring;';
      Char(198): Result := Result + '&AElig;';
      Char(199): Result := Result + '&Ccedil;';
      Char(200): Result := Result + '&Egrave;';
      Char(201): Result := Result + '&Eacute;';
      Char(202): Result := Result + '&Ecirc;';
      Char(203): Result := Result + '&Euml;';
      Char(204): Result := Result + '&Igrave;';
      Char(205): Result := Result + '&Iacute;';
      Char(206): Result := Result + '&Icirc;';
      Char(207): Result := Result + '&Iuml;';
      Char(208): Result := Result + '&ETH;';
      Char(209): Result := Result + '&Ntilde;';
      Char(210): Result := Result + '&Ograve;';
      Char(211): Result := Result + '&Oacute;';
      Char(212): Result := Result + '&Ocirc;';
      Char(213): Result := Result + '&Otilde;';
      Char(214): Result := Result + '&Ouml;';
      Char(215): Result := Result + '&times;';
      Char(216): Result := Result + '&Oslash;';
      Char(217): Result := Result + '&Ugrave;';
      Char(218): Result := Result + '&Uacute;';
      Char(219): Result := Result + '&Ucirc;';
      Char(220): Result := Result + '&Uuml;';
      Char(221): Result := Result + '&Yacute;';
      Char(222): Result := Result + '&THORN;';
      Char(223): Result := Result + '&szlig;';
      Char(224): Result := Result + '&agrave;';
      Char(225): Result := Result + '&aacute;';
      Char(226): Result := Result + '&acirc;';
      Char(227): Result := Result + '&atilde;';
      Char(228): Result := Result + '&auml;';
      Char(229): Result := Result + '&aring;';
      Char(230): Result := Result + '&aelig;';
      Char(231): Result := Result + '&ccedil;';
      Char(232): Result := Result + '&egrave;';
      Char(233): Result := Result + '&eacute;';
      Char(234): Result := Result + '&ecirc;';
      Char(235): Result := Result + '&euml;';
      Char(236): Result := Result + '&igrave;';
      Char(237): Result := Result + '&iacute;';
      Char(238): Result := Result + '&icirc;';
      Char(239): Result := Result + '&iuml;';
      Char(240): Result := Result + '&eth;';
      Char(241): Result := Result + '&ntilde;';
      Char(242): Result := Result + '&ograve;';
      Char(243): Result := Result + '&oacute;';
      Char(244): Result := Result + '&ocirc;';
      Char(245): Result := Result + '&otilde;';
      Char(246): Result := Result + '&ouml;';
      Char(247): Result := Result + '&divide;';
      Char(248): Result := Result + '&oslash;';
      Char(249): Result := Result + '&ugrave;';
      Char(250): Result := Result + '&uacute;';
      Char(251): Result := Result + '&ucirc;';
